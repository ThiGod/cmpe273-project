...
<title>Kids On Track - Admin Signup</title>
...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    ...
    <a href="#" class="brand">Kids On Track</a>
...
<div class="container login">
    <div class="row ">
        <div class="center span4 well">
            ...
            <input type="text" id="firstName" class="span4" name="firstName" placeholder="First Name" />
            <input type="text" id="lastName" class="span4" name="lastName" placeholder="Last Name" />
...
<p class="text-center muted ">&copy; Copyright 2013 - Kids On Track</p>
</section>
<!-- Main Container Ends -->
